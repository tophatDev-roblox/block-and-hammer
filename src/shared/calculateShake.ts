export function calculateUIRotation(shakeStrength: number, time: number, id: number, angle: number = 15): number {
...
export function calculateCameraRotation(shakeStrength: number, time: number, maxAngle: number = 5): CFrame {
